...
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{height: flags.height, projInfo: _List_Nil, svgStr: '', width: flags.width},
...
var author$project$Main$graphStyle = _Utils_update(
	elm_community$graph$Graph$DOT$defaultStyles,
	{node: 'shape = box, colorscheme = set312', rankdir: elm_community$graph$Graph$DOT$LR});
				...
				function (mi, acc) {
					var currentEdges = function () {
						var _n0 = A2(
							...
							A2(elm$core$Dict$get, mi.modName, nodes));
						if (_n0.$ === 'Just') {
							var mId = _n0.a;
							return A2(
								elm$core$List$filterMap,
								...
								A2(
									elm$core$List$map,
									function (i) {
										var _n1 = A2(elm$core$Dict$get, i.impName, nodes);
										if (_n1.$ === 'Just') {
											var node = _n1.a;
											return elm$core$Maybe$Just(
												A3(elm_community$graph$Graph$Edge, node.id, mId, ''));
										} else {
											return elm$core$Maybe$Nothing;
										}
									},
...
var author$project$Main$NodeLabel = F2(
	function (group, attrs) {
		return {attrs: attrs, group: group};
	});
	...
	return author$project$Main$groupNodes(
		elm$core$Dict$fromList(
			A2(
				elm$core$List$map,
				function (n) {
					return _Utils_Tuple2(n.label, n);
				},
				A2(
					elm$core$List$indexedMap,
					F2(
						function (i, mi) {
							return A2(elm_community$graph$Graph$Node, i, mi.modName);
						}),
					mis))));
};
...
var elm_community$graph$Graph$DOT$outputWithStylesAndAttributes = F4(
	function (styles, nodeAttrs, edgeAttrs, graph) {
		...
		var edges = function () {
			var compareEdge = F2(
				function (a, b) {
					var _n1 = A2(elm$core$Basics$compare, a.from, b.from);
					switch (_n1.$) {
						case 'LT':
...
var author$project$Main$graphDOTStr = function (mis) {
	return A4(
		elm_community$graph$Graph$DOT$outputWithStylesAndAttributes,
		author$project$Main$graphStyle,
		function ($) {
			return $.attrs;
		},
		function (l) {
			return elm$core$Dict$fromList(
				_List_fromArray(
					[
						_Utils_Tuple2('label', l)
					]));
		},
		author$project$Main$makeGraph(mis));
};
var author$project$Main$ModuleInfo = F4(
	function (nbrLoc, imports, exports, modName) {
		return {exports: exports, imports: imports, modName: modName, nbrLoc: nbrLoc};
	});
var author$project$Main$Export = F2(
	function (expTypes, expFun) {
		return {expFun: expFun, expTypes: expTypes};
	});
...
var author$project$Main$Import = F3(
	function (impName, impTypes, impFun) {
		return {impFun: impFun, impName: impName, impTypes: impTypes};
	});
				...
				if (_n1.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						author$project$Main$toRender(
							author$project$Main$graphDOTStr(data)));
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'RenderGraph':
				return _Utils_Tuple2(
					model,
					author$project$Main$toRender(
						author$project$Main$graphDOTStr(model.projInfo)));
			case 'SvgStr':
				var s = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							svgStr: author$project$Main$trimXml(s)
						}),
					elm$core$Platform$Cmd$none);
			case 'WinResize':
				var width = msg.a;
...
var author$project$Main$svgElement = function (model) {
	var _n0 = Garados007$elm_svg_parser$SvgParser$parseToNode(model.svgStr);
	if ((_n0.$ === 'Ok') && (_n0.a.$ === 'SvgElement')) {
		var element = _n0.a.a;
		var attributes = elm$core$Dict$fromList(element.attributes);
		var height = A2(
			elm$core$Maybe$withDefault,
			1,
			A2(
		...
		var newAttr = elm$core$Dict$toList(
			A3(
				...
				'height',
				elm$core$String$fromInt(
					elm$core$Basics$round(model.width / ratio)) + 'px',
				A3(
					elm$core$Dict$insert,
					'width',
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_Nil,
							{
								label: mdgriffith$elm_ui$Element$text('Load projInfo'),
								onPress: elm$core$Maybe$Just(author$project$Main$RequestFile)
							}),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'width', elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"RequestFile":[],"FileLoaded":["File.File"],"ContentLoaded":["String.String"],"RenderGraph":[],"SvgStr":["String.String"],"WinResize":["Basics.Int","Basics.Int"],"NoOp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}},"File.File":{"args":[],"tags":{"File":[]}}}}})}});}(this));